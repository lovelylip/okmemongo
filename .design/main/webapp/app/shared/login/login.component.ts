...
export class LoginModalComponent implements AfterViewInit {
  constructor(public __elementSelectionService:ElementSelectionService,private __componentInspectorService:ComponentInspectorService) { this.__componentInspectorService.getComp(this); }@ViewChild('username', { static: false })
  username?: ElementRef;
